 ...
 */
export const ZKLOGIN_PROVIDERS: Record<
  OAuthProvider,
...
> = {
  ...
  [OAuthProvider.AWS_TENANT]: {
    discoveryEndpoint:
      "https://{tenant}.auth.{region}.amazoncognito.com/.well-known/openid-configuration",
    jwksUri:
      "https://{tenant}.auth.{region}.amazoncognito.com/.well-known/jwks.json",
    authorizationEndpoint:
      "https://{tenant}.auth.{region}.amazoncognito.com/oauth2/authorize",
    tokenEndpoint:
      "https://{tenant}.auth.{region}.amazoncognito.com/oauth2/token",
    scope: ["openid", "profile", "email"],
    supportedNetworks: ["devnet", "testnet", "mainnet"],
  },
...
export const ZKLOGIN_CRYPTO_CONFIG = {
  ...
  field: {
    curve: "BN254",
    fieldModulus:
      "0x30644e72e131a029b85045b68181585d2833e82519b4b96e27f1ead2aaef25f", // p in BN254
  },
};
