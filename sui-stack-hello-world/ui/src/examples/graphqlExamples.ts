/**
 * GraphQL Examples for Sui
 * Practical examples of GraphQL queries and operations
 */
...
export async function example3_paginateTransactions() {
  ...
  try {
    ...
    const response = await client.getTransactionBlocks(
      ...
      {
        affectedAddress: '0x1234567890123456789012345678901234567890123456789012345678901234',
      }
    );

    console.log('First page of transactions:', response.data?.transactionBlocks);
    ...
    if (response.data?.transactionBlocks?.pageInfo?.hasNextPage) {
      ...
      console.log('Next page of transactions:', nextResponse.data?.transactionBlocks);
      return {
...
export async function example4_getObjectDetails() {
  ...
  try {
    const objectId = '0x1234567890123456789012345678901234567890123456789012345678901234';
...
export async function example5_getCoinBalance() {
  ...
  try {
    const owner = '0x1234567890123456789012345678901234567890123456789012345678901234';
...
export async function example9_getDataRetention() {
  ...
  try {
    ...
    console.log('Data retention information:', response.data?.serviceConfig?.retention);
...
export async function example13_errorHandling() {
  ...
  try {
    ...
    const response = await client.getObject('0x00000000000000000000000000000000');
